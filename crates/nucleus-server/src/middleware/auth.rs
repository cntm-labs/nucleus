...
pub fn verify_key_hash(provided_hash: &str, stored_hash: &str) -> bool {
    nucleus_core::crypto::constant_time_eq(provided_hash.as_bytes(), stored_hash.as_bytes())
}
...
mod tests {
    ...
    fn validate_api_key_rejects_revoked() {
        let key = nucleus_db::repos::api_key_repo::ApiKey {
            id: nucleus_core::types::ApiKeyId::new(),
            project_id: nucleus_core::types::ProjectId::new(),
