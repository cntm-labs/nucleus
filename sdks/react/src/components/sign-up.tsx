    ...
    <div style={s.card}>
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ display: 'flex', gap: 8 }}>
          <input
            type="text" placeholder={t('signUp.firstName')} value={firstName}
            onChange={e => setFirstName(e.target.value)}
            style={{ ...s.input, flex: 1 }}
          />
          <input
            type="text" placeholder={t('signUp.lastName')} value={lastName}
        ...
        />
        <input
          type="password" placeholder={t('signUp.password')} value={password}
