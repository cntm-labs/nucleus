...
const defaultStyles: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: 24, fontWeight: 'bold', marginBottom: 16, textAlign: 'center' as const },
  input: {
  ...
  button: {
    ...
    border: 'none', borderRadius: 'var(--nucleus-radius, 6px)',
  ...
  divider: { display: 'flex', alignItems: 'center', gap: 12, margin: '16px 0', color: '#9ca3af', fontSize: 13 },
  dividerLine: { flex: 1, height: 1, background: '#e5e7eb' },
}

export function useStyles() { return defaultStyles }
