      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="session-ttl" className="block text-sm font-medium mb-1">Session TTL (seconds)</label>
              <input id="session-ttl" type="number" value={settings.session_ttl}
            ...
            <div>
              <label htmlFor="jwt-lifetime" className="block text-sm font-medium mb-1">JWT Lifetime (seconds)</label>
              <input id="jwt-lifetime" type="number" value={settings.jwt_lifetime}
