...
use crate::identity::handlers::admin::{AdminUpdateUserRequest, CreateUserRequest};
...
fn require_admin(api_key: &ApiKeyAuth) -> Result<(), AppError> {
    if api_key.key_type != "secret" {
        return Err(AppError::Auth(crate::core::error::AuthError::TokenInvalid));
    }
...
pub async fn handle_admin_list_users(
    ...
    let result = crate::identity::handlers::admin::list_users(
        &state.user_service,
        &api_key.project_id,
        &params,
    )
...
pub async fn handle_admin_create_user(
    ...
    let user = crate::identity::handlers::admin::create_user(
        &state.user_service,
        &api_key.project_id,
        req,
    )
...
pub async fn handle_admin_get_user(
    ...
    let user = crate::identity::handlers::admin::get_user(
        &state.user_service,
        &api_key.project_id,
        &user_id,
    )
...
pub async fn handle_admin_update_user(
    ...
    let user = crate::identity::handlers::admin::update_user(
        &state.user_service,
        &api_key.project_id,
        &user_id,
        req,
...
pub async fn handle_admin_delete_user(
    ...
    crate::identity::handlers::admin::delete_user(
        &state.user_service,
        &api_key.project_id,
        &user_id,
    )
...
pub async fn handle_admin_unban_user(
    ...
    crate::identity::handlers::admin::unban_user(
        &state.user_service,
        &api_key.project_id,
        &user_id,
    )
