...
pub struct OAuthHandlerState {
    ...
    pub auth_service: Arc<crate::auth::service::AuthService>,
}
...
async fn create_or_link_user(
    auth_service: &crate::auth::service::AuthService,
    project_id: &ProjectId,
    user_info: &OAuthUserInfo,
) -> Result<(crate::db::repos::user_repo::User, String, bool), AppError> {
